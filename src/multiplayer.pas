...
type
  ...
  public
    ...
    kicked:string; //olvasd majd t�r�ld ki
    kickedhard:boolean;
...
const
 ...
 vagy
   ...
   byte gun koordin�tasz�m
   byte tech koordin�tasz�m
  ...
  P2PMSG_STATUS = 4; // pillanatnyilag haszn�laton k�v�l.


  // a P2PMSG_STATUS hoz tartoz� �zenetek

  STATUS_CHATON = 1; // m�r nem haszn�lt

  STATUS_CHATOFF = 2; // m�r nem haszn�lt
...
begin
  ...
  //rem�lem senki sem fog egyszerre 4 med�lt szerezni.
end;
...
begin
  ...
  b:=frame.ReadChar;
  isCoord:=nthBit(b, 0);
  //ha igen akkor hozz�rakjuk a megl�vokh�z
  if isCoord then
  begin
    if warevent_dm then
    begin
      b:=frame.ReadChar; //�j koordin�t�k sz�ma
      frame.ReadChar; //�res
    ...
    begin
      b:=frame.ReadChar; //�j gun koordin�t�k sz�ma
      c:=frame.ReadChar; //�j tech koordin�t�k sz�ma
...
{$ENDIF}
  ...
  if laststatus < GetTickCount - 3000 then //TODO nem ett�l fagy a szerver?
  begin
